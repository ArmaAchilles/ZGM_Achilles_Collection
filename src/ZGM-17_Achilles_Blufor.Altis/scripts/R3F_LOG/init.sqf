...
#include "R3F_LOG_ENABLE.h"
	...
	if (isServer) then
	{
		...
		execVM "scripts\R3F_LOG\surveiller_objets_a_proteger.sqf";
	};
	...
	call compileFinal preprocessFile "scripts\R3F_LOG\fonctions_generales\lib_geometrie_3D.sqf";
	...
	R3F_LOG_FNCT_determiner_fonctionnalites_logistique = compileFinal preprocessFile "scripts\R3F_LOG\fonctions_generales\determiner_fonctionnalites_logistique.sqf";
	
	R3F_LOG_FNCT_calculer_chargement_vehicule = compileFinal preprocessFile "scripts\R3F_LOG\transporteur\calculer_chargement_vehicule.sqf";
	R3F_LOG_FNCT_transporteur_charger_auto = compileFinal preprocessFile "scripts\R3F_LOG\transporteur\charger_auto.sqf";
	...
	if !(isDedicated) then
	{
		...
		R3F_LOG_FNCT_heliporteur_heliporter = compileFinal preprocessFile "scripts\R3F_LOG\heliporteur\heliporter.sqf";
		R3F_LOG_FNCT_heliporteur_larguer = compileFinal preprocessFile "scripts\R3F_LOG\heliporteur\larguer.sqf";
		R3F_LOG_FNCT_heliporteur_init = compileFinal preprocessFile "scripts\R3F_LOG\heliporteur\heliporteur_init.sqf";
		
		R3F_LOG_FNCT_remorqueur_detacher = compileFinal preprocessFile "scripts\R3F_LOG\remorqueur\detacher.sqf";
		R3F_LOG_FNCT_remorqueur_remorquer_deplace = compileFinal preprocessFile "scripts\R3F_LOG\remorqueur\remorquer_deplace.sqf";
		R3F_LOG_FNCT_remorqueur_remorquer_direct = compileFinal preprocessFile "scripts\R3F_LOG\remorqueur\remorquer_direct.sqf";
		R3F_LOG_FNCT_remorqueur_init = compileFinal preprocessFile "scripts\R3F_LOG\remorqueur\remorqueur_init.sqf";
		
		R3F_LOG_FNCT_transporteur_charger_deplace = compileFinal preprocessFile "scripts\R3F_LOG\transporteur\charger_deplace.sqf";
		R3F_LOG_FNCT_transporteur_charger_selection = compileFinal preprocessFile "scripts\R3F_LOG\transporteur\charger_selection.sqf";
		R3F_LOG_FNCT_transporteur_decharger = compileFinal preprocessFile "scripts\R3F_LOG\transporteur\decharger.sqf";
		...
		R3F_LOG_FNCT_deverrouiller_objet = compileFinal preprocessFile "scripts\R3F_LOG\objet_commun\deverrouiller_objet.sqf";
		R3F_LOG_FNCT_definir_proprietaire_verrou = compileFinal preprocessFile "scripts\R3F_LOG\objet_commun\definir_proprietaire_verrou.sqf";
		
		R3F_LOG_FNCT_formater_fonctionnalites_logistique = compileFinal preprocessFile "scripts\R3F_LOG\fonctions_generales\formater_fonctionnalites_logistique.sqf";
		R3F_LOG_FNCT_formater_nombre_entier_milliers = compileFinal preprocessFile "scripts\R3F_LOG\fonctions_generales\formater_nombre_entier_milliers.sqf";
		...
		execVM "scripts\R3F_LOG\surveiller_conditions_actions_menu.sqf";
		
		/* Auto-détection permanente des objets sur le jeu */
		execVM "scripts\R3F_LOG\surveiller_nouveaux_objets.sqf";
		 ...
		 */
		execVM "scripts\R3F_LOG\systeme_protection_blessures.sqf";
	};
