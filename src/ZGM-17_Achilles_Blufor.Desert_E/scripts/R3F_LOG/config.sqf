 ...
 */
private _r3f_log_enabled_by_default = ["R3fLogEnabledByDefault", DEFAULT_R3F_LOG_ENABLED_BY_DEFAULT] call BIS_fnc_getParamValue;
R3F_LOG_CFG_disabled_by_default = if(_r3f_log_enabled_by_default == 1) then {false} else {true};
